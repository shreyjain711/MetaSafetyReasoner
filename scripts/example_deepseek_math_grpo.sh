...
export train_files=[/data/user_data/jamesdin/gsm8k/train.parquet]
export test_files=[/data/user_data/jamesdin/gsm8k/test.parquet]

export project_name=qwen_msr_grpo
...
export model_path=${DATA_DIR}/models/Qwen3-4B-Instruct-2507
